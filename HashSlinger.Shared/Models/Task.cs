...
public record Task
{
    ...
    public virtual int? CrackerBinaryId { get; set; }
    ...
    /// <summary>Gets or sets a value indicating whether to use Speed benchmark.</summary>
    /// <value><c>true</c> if uses Speed benchmark; otherwise, <c>false</c> if using Run Time benchmark.</value>
