...
public record Agent
{
    ...
    /// <autogeneratedoc />
    [StringLength(256)]
    public string CommandParameters { get; set; } = null!;

    /// <summary>Gets or sets a value indicating whether [ignore errors].</summary>
    /// <value>
    ///   <c>true</c> if [ignore errors]; otherwise, <c>false</c>.</value>
    /// <autogeneratedoc />
    ...
    /// <value>
    ///   <c>true</c> if this instance is trusted; otherwise, <c>false</c>.</value>
    /// <autogeneratedoc />
    ...
    /// <autogeneratedoc />
    [StringLength(50)]
    public string LastAct { get; set; } = null!;
    ...
    /// <value>
    ///   <c>true</c> if [cpu only]; otherwise, <c>false</c>.</value>
    /// <autogeneratedoc />
    ...
    /// <autogeneratedoc />
    [StringLength(50)]
    public string ClientSignature { get; set; } = null!;
