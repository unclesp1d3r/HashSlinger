...
public class Hashlist
{
    ...
    /// <autogeneratedoc />
    [StringLength(100)]
    public string HashlistName { get; set; } = null!;
    ...
    /// <value>
    ///   <c>true</c> if [hexadecimal salt]; otherwise, <c>false</c>.</value>
    /// <autogeneratedoc />
    ...
    /// <autogeneratedoc />
    [InverseProperty("Hashlist")]
    public virtual ICollection<HashlistHashlist> HashlistHashlistHashlists { get; set; } = new List<HashlistHashlist>();

    /// <summary>Gets or sets the hashlist hashlist parent hashlists.</summary>
    /// <value>The hashlist hashlist parent hashlists.</value>
    /// <autogeneratedoc />
    [InverseProperty("ParentHashlist")]
