...
public class Task
{
    ...
    /// <summary>Gets or sets a value indicating whether to use speed benchmark or fall back to time.</summary>
    /// <value>
    ///   <c>true</c> if use speed benchmark; otherwise, <c>false</c>.</value>
    /// <remarks>We could find a better name for this.</remarks>
    /// <autogeneratedoc />
    ...
    /// <value>
    ///   <c>true</c> if [force pipe]; otherwise, <c>false</c>.</value>
    /// <autogeneratedoc />
    public bool ForcePipe { get; set; }

    /// <summary>Gets or sets a value indicating whether [use preprocessor].</summary>
    /// <value>
    ///   <c>true</c> if [use preprocessor]; otherwise, <c>false</c>.</value>
    /// <autogeneratedoc />
    ...
    /// <autogeneratedoc />
    [ForeignKey("CrackerBinaryTypeId")]
    [InverseProperty("Tasks")]
