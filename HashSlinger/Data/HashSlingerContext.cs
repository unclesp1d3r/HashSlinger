...
public class HashSlingerContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AgentBinary>(entity => { entity.HasBaseType<DownloadableBinary>(); });
        ...
        modelBuilder.Entity<Chunk>(entity =>
        {
            ...
            entity.HasMany(e => e.HashBinaries).WithOne(e => e.Chunk).OnDelete(DeleteBehavior.ClientSetNull);
        ...
        modelBuilder.Entity<CrackerBinary>(entity =>
        {
            ...
            entity.HasOne(d => d.CrackerBinaryType).WithMany(p => p.CrackerBinaries).OnDelete(DeleteBehavior.ClientSetNull);
        ...
        modelBuilder.Entity<Hashlist>(entity =>
        {
            ...
            entity.HasMany(e => e.TaskWrappers).WithOne(e => e.Hashlist).OnDelete(DeleteBehavior.ClientSetNull);
            entity.HasMany(e => e.Zaps).WithOne(e => e.Hashlist).OnDelete(DeleteBehavior.Cascade);
            entity.HasMany(e => e.HashBinaries).WithOne(e => e.Hashlist).OnDelete(DeleteBehavior.Cascade);
        });
