...
public class GetDeletedFilesHandler : IRequestHandler<GetDeletedFilesQuery, List<FileDelete>>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="GetDeletedFilesHandler" /> class.</summary>
    /// <param name="dbContext">The database context.</param>
    public GetDeletedFilesHandler(HashSlingerContext dbContext) => _dbContext = dbContext;
